...
app.use('/api', uploadRoutes); // Ensure uploadRoutes is being correctly used

// Use OTP routes with /api prefix
app.use("/api", otpRoutes); 

// Route to handle file uploads (if this is separate from uploadRoutes)
